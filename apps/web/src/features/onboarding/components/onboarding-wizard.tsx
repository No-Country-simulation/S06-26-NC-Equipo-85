 ...
 * El guard evita romper el prerender si el store no expone `.persist`.
 */
...
/**
 * Wizard principal de Fase 2.
 *
 * Mantiene la ruta como Server Component y encapsula la interactividad en esta
 * hoja cliente: formularios, validación progresiva, navegación de pasos y
 * persistencia del draft en Zustand.
 */
export function OnboardingWizard() {
    ...
    useEffect(() => {
        ...
        return persistApi.onFinishHydration(loadDraftFromStore);
    }, [reset]);
